...
static const char *TAG = "MULTI_WAKE_WORD_EXAMPLE";

// Hardware Config
#define I2S_MIC_BCK_PIN     GPIO_NUM_1
#define I2S_MIC_WS_PIN      GPIO_NUM_3
#define I2S_MIC_SD_PIN      GPIO_NUM_2
#define I2S_MIC_PORT        I2S_NUM_0

#define I2S_SPEAKER_BCLK_PIN    GPIO_NUM_26
#define I2S_SPEAKER_LRC_PIN     GPIO_NUM_25
#define I2S_SPEAKER_DOUT_PIN    GPIO_NUM_22
...
extern "C" void app_main(void) {
    ...
    wake_word.add_wake_word_model(const_cast<uint8_t *>(BMO_tflite), 0.97f, 5, "BMO", 22940);
    wake_word.add_wake_word_model(const_cast<uint8_t *>(alexa_tflite), 0.97f, 5, "alexa", 22940);
    wake_word.add_wake_word_model(const_cast<uint8_t *>(hey_jarvis_tflite), 0.97f, 5, "hey_jarvis", 22940);
