...
extern "C" void app_main(void) {
    ...
    wake_word.add_wake_word_model(const_cast<uint8_t *>(BMO_tflite), 0.97f, 5, "Hey Jarvis", 22940);
    ...
    ESP_LOGI(TAG, "Setup complete. System is running and listening for 'Hey Jarvis'.");
